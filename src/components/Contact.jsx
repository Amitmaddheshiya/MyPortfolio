      ...
      <div className="flex flex-col-reverse gap-10 overflow-hidden md:mt-12 md:flex-row ">
        ...
        >
          ...
          <div className="flex-center-center mt-8 flex-wrap gap-2">
            <div>
            <a href="mailto:mern.dev.amitmaddheshiya999@gmail.com">
            ...
            <div>
              <a
                href="https://github.com/Amitmaddheshiya"
                target="_blank"
                rel="noopener noreferrer"
              >
      ...
      <div className="mb-4 ml-5">
        ...
        <div>
          <a
            target="_blank"
            rel="noopener noreferrer"
            href="https://drive.google.com/file/d/13wC0yJL7TqZkvmZtJ4vE96_4ohxsSSgy/view?usp=sharing"
          >
