...
const About = () => {
  ...
  let layoutClass;
if (isSmallScreen) {
  layoutClass = "linearToL";
} else if (isLargeScreen) {
  layoutClass = "linearToB";
} else {
  layoutClass = "circle";
}
  return (
    <div>
      ...
      <div
        className={`flex-center-center ${layoutClass} mt-20 flex-wrap gap-10`}
      >
      ...
      <div className="flex-center-center mt-20 flex-col">
        ...
        <div className="mt-2 flex flex-wrap  justify-center gap-10 ">
          {technologies.map((item, i) => (
            <div key={item.name} className="flex-around-center w-[80px] flex-col">
      ...
      <div className="flex-center-center mt-32 mb-20 flex-col">
